...
class ValueList extends Controller
{
    ...
    {	
        ...
        foreach ($list as $list) {
        	$moreTypeLi .= '<li class="sidebar-nav-item"><a class="js-scroll-trigger" href="/index/md_content/mdcontent/moretype_id/'.$list['moretype_id'].'/type_id/'.$type_id.'">'.$list['moretype_name'].'</a></li>';
        	$listValue .=  '<div class="col-lg-3">
        						<a class="portfolio-item" href="/index/md_content/mdcontent/moretype_id/'.$list['moretype_id'].'/type_id/'.$type_id.'">
	        	              		<span class="caption">
